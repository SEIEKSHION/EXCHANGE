...
// Создание сервера
func NewServer(addr string, exchangehandler *handlers.Handler) (*Server, error) {
...
func StartServer(addr string, exchangehandler *handlers.Handler) error {
	server, err := NewServer(addr, exchangehandler)
	if err != nil {
